    ...
    <div class="panel-body">
        ...
        {{ csrf_field() }}
		    <div class="form-group">
                ...
                <div id="js-help-name" style="color:red;text-align: center"></div>
            </div>
            <div class="form-group">
                ...
                <div id="js-help-email" style="color: red;text-align: center"></div>
            </div>
            <div class="form-group">
                ...
                <div id="js-help-password" style="color: red;text-align: center"></div>								
            </div>
            <div class="form-group">
